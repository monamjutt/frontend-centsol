...
class ProductProvider extends Component{
  ...
  setProducts = () => {
    ...
    this.setState(() => {
      return {productList: tempProducts, detailProduct: tempProducts}
    });
  }
  ...
  increment = id => {
    ...
    let tempCartProduct = tempCart.find(item => item.id === id);
    const index = tempCart.indexOf(tempCartProduct);
